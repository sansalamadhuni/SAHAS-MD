...
module.exports = {
  //==========================================- MAIN - CONFIGS -==================================================================
  SESSION_ID: process.env.SESSION_ID || "0KkTyITS#p2qk9It0eRSQ6-UU8z6XoHvUH7vzSrDYEVGrA8Vd9ho",
  // ADD Your Session Id 
  MONGODB: process.env.MONGODB || "AekEQCxR#50uxdNQsLC49KrR9YbzbQz7P03r4_HXhurDm6UP6FwU",
